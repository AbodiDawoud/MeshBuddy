...
struct MeshGradientEditor: View {
    ...
    @AppStorage("controlsVisible") private var controlsVisible = true
    ...
    private var primaryToolbar: some View {
        HStack(spacing: 26) {
            ...
            .toggleStyle(.button)
            .help(controlsVisible ? "Hide Controls" : "Show Controls")
...
fileprivate struct ActionBarButtonStyle: ButtonStyle {
